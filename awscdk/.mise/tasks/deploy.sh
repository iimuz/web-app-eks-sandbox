#!/usr/bin/env bash
#MISE description="Deploy AWS CDK stacks."
...
EXAMPLES:
    ${SCRIPT_NAME}              # Deploy CDK stacks
    ${SCRIPT_NAME} --verbose    # Deploy with verbose output
...
function main() {
  ...
  pnpm exec cdk deploy "**" --require-approval=never --stage=Dev
}
